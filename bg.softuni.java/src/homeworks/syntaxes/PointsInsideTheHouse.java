...
public class PointsInsideTheHouse {
	...
	public static void main(String[] args) {
		 ...
		 */
		// if pointPosition1 is negative or zero point is on the left or on the line
		float pointPosition1 = calcPointPositionToLine(leftTipX, leftTipY,
				rightTipX, rightTipY, pX, pY);
		// if pointPosition2 is positive or zero point is on the right or on the line
		float pointPosition2 = calcPointPositionToLine(leftTipX, leftTipY,
				topX, topY, pX, pY);
		// if pointPosition3 is negative or zero point is on the left or on the line
